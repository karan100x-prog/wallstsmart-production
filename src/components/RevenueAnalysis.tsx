  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl border border-cyan-500/20 p-8 mb-6 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-gradient-to-br from-cyan-500/10 to-cyan-600/5 rounded-xl p-4 border border-cyan-500/20">
            <div className="flex items-center justify-between mb-2">
              <span className="text-gray-400 text-sm">Latest Revenue</span>
              <TrendingUp className="w-4 h-4 text-cyan-400" />
            </div>
            <p className="text-2xl font-bold text-white">
              {financialData.length > 0 && !financialData[financialData.length - 1].isProjected
                ? formatValue(financialData[financialData.length - 1].revenue)
                : 'N/A'}
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-500/10 to-purple-600/5 rounded-xl p-4 border border-purple-500/20">
            ...
            <p className={`text-2xl font-bold ${projectedGrowthRate >= 0 ? 'text-green-400' : 'text-red-400'}`}>
        ...
        {/* Main Chart */}
        <div className="h-96 bg-gray-800/30 rounded-xl p-4 backdrop-blur border border-gray-700/50">
            ...
            >
                ...
                shape={(props: any) => {
                  ...
                  return (
                    <g>
                      ...
                      {payload.isProjected && (
                        <text x={x + width/2} y={y - 5} fill="#3b82f6" fontSize="10" textAnchor="middle">
                          Est
                        </text>
                      )}
                    </g>
              ...
              <Bar 
                ...
                shape={(props: any) => {
                  ...
                  const gradient = isNegative ? 'url(#netIncomeNegative)' : 'url(#netIncomePositive)';
                  ...
                  return (
                    <g>
                      <rect 
                        ...
                        rx={8} 
                        ry={8}
                        opacity={payload.isProjected ? 0.7 : 1}
                      />
                    </g>
                  );
                }}
